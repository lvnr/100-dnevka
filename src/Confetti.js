class Confetti {
    ...
    constructor() {
      ...
      // TODO: allow ability to specify custom target element
      ...
      updateParticles = () => {
          ...
          for (let i = 0; i < this.particles.length; i++) {
              ...
              if (!this.streamingConfetti && particle.y < -15)
                  ...
                  particle.x += Math.sin(this.waveAngle) - 0.2
                  particle.y += (Math.cos(this.waveAngle) + particle.diameter + this.confetti.speed) * 0.2
